...
describe('dGoods SDK', () => {
  const dgoods: DGoods = null as any

  it.skip('should instantiate a dgoods instance', async () => {
  ...
  it.skip('should be able to get the token configs', async () => {
    // assert(await dgoods.getConfig(), 'Could not get token configs')
  })

  it.skip('should be able to get categories', async () => {
  ...
  it.skip('should be able to get token stats', async () => {
    // const allCategories = await dgoods.getCategory()
  ...
  it.skip('should be able to get account tokens', async () => {
  ...
  it.skip('should be able to get token infos', async () => {
  ...
  it.skip('should be able to transact single actions', async () => {
    // await dgoods.setconfig('EOS', '1.0.0').send()
  })

  it.skip('should be able to transact multiple actions', async () => {
  ...
  it.skip('should be able to transact multiple actions along with other cleartext actions', async () => {
    // await dgoods.transact([
    //   dgoods.setconfig('EOS', '1.0.0'),
